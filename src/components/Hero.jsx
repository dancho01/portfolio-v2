        ...
        <div className='max-w-[1000px] h-full flex flex-col mx-auto px-8 justify-center text-center sm:text-left text-gray-300'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
                <div>
                    ...
                    <h1 className='text-6xl md:text-7xl font-semibold py-3 bg-gradient-to-r from-[#0870ee] to-[#13c634] bg-clip-text text-transparent '>Daniel Cho</h1>
                    <h2 className='text-2xl md:text-3xl text-white font-semibold'>UNSW Comp Sci Student 👨🏻‍🎓</h2>
                    <p className='text-xl md:text-2xl py-3'>I'm a driven and diligent team player and a learner with a keen interest in web developement 👨🏻‍💻</p>
                    ...
                    <a className='hover:scale-110 duration-200' href={resume} target='blank'>
                    <BsFillPersonLinesFill size={35}/>
                    </a>
                    </div>

                    <div>
                        <button className='bg-orange-600 font-bold group my-6 px-4 py-3 hover:bg-gray-300 hover:text-orange-600 duration-300 rounded-md mx-auto sm:mx-0'>
                ...
                <div>
                    <img className='w-[200px] md:w-[300px] rounded-xl mx-auto' src={portrait} alt="portrait"/>
                </div>
            </div>
        </div>
    </div>
