...
const About2 = () => {
  ...
  return (
    <div id='about-section' className='w-full h-auto md:h-screen bg-[#1f1e1e]'>
        <div className='h-full max-w-[1000px] flex flex-col mx-auto text-gray-400 px-8 text-xl pt-14'>
            ...
            <div className='grid md:grid-cols-2 gap-8 my-4'>
                ...
                Hi, my name is Daniel and I am a currently a UNSW student studying <span className='text-[white] font-extrabold'>Bachelor of Computer Science</span> and I have a keen interest in <span className='text-white font-extrabold'>web development</span>. Having self taught <span className='text-white font-extrabold'>HTML</span>, <span className='text-white font-extrabold'>CSS</span> and <span className='text-white font-extrabold'>JavaScript</span>, I have been able to use the knowledge I gained and start building my own webpages that is both interactive and visually appealing. 
                </div>
                <div>
            ...
            <div className='grid grid-cols-3 my-4 gap-4'>
                <div className='col-span-1 font-semibold' >
                    <div className='flex flex-col text-center'>
                        <button onClick={() => handleClick('language')} className={tech==='language' ? 'text-[#0097b2] border-blue-400 border-l-4 py-2 bg-[#282828] duration-500' : 'border-l-2 border-blue-400 py-2 hover:bg-[#282828] duration-500'}>Languages</button>
                        <button onClick={() => handleClick('framework')} className={tech==='framework' ? 'text-[#0097b2] border-blue-400 border-l-4 py-2 bg-[#282828] duration-500' : 'border-l-2 border-blue-400 py-2 hover:bg-[#282828] duration-500'}>Framworks</button>
                    </div>
                </div>
                <div className='col-span-2 text-white font-semibold'>
                    {tech === 'language' ? 
                      <div className='flex gap-3 flex-wrap justify-center sm:justify-start'>
                        <div className='flex items-center hover:scale-110 duration-500 bg-[#282828] px-3 py-1 rounded-md'>
